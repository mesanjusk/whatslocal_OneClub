...
import { LuUser, LuSmartphone, LuLock, LuEye, LuEyeOff } from "react-icons/lu"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post("/api/auth/register", {
        name: form.name,
        email: `${form.mobile}@whatslocal.in`,
        phone: form.mobile,
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Join Gondia&apos;s food community</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-3.5 py-3 border border-transparent focus-within:border-[#e23744]/40">
              <LuUser size={18} className="text-gray-400 shrink-0" />
              <input
                type="text"
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link href="/login" className="font-semibold text-[#e23744] hover:underline">
              Sign in
            </Link>
          </p>
        </div>
